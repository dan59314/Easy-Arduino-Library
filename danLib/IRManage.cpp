...
TIRManager::TIRManager(byte val,  void(*pCallbackFunc)(TIRManager *, byte &paramVal))
{
	CreateMembers();
	InitialMembers();
...
void TIRManager::Initial(byte val, void(*pCallbackFunc)(TIRManager *, byte &paramVal))
{
	FOnCallBack_myCheck = pCallbackFunc;
}

void TIRManager::CreateMembers()
{

}

void TIRManager::InitialMembers()
{

}

void TIRManager::ReleaseMembers()
{

}


void TIRManager::Check_Run()
{
	//DomyCheck();
}
