...
/*
enum TDanEnum {
  slLeft1, slRight1, slLeft2, slRight2, slLeft3, slRight3
};
...
/* Global 變數的宣告，必須在 .cpp 宣告並給予初值， 
   另外必須在 .h 內的宣告時候，前面加上  extern
...
extern int Get_CheckSum(String sStr);
extern byte Get_CheckSum_Byte(String sStr);
extern byte CRC8(const byte *data, byte len);
extern void ByteArrayToString(byte byteAry[], String &str);
extern void StringToByteArray(String str, int arrayLength, byte* byteAry);
