...
#ifndef _PCSerialManage_h
#define _PCSerialManage_h
...
class TPCSerialManager
{
private:
#ifdef StoreInputWithString
#else
#endif
  String FLineStr;
  long FBaudRate=115200;

  void(*FOnProcessString)(String &str); /*TPCSerialManager　的　Class callback function*/
...
public:
  ...
  TPCSerialManager(long BaudRate=115200, void(*pProcessString)(String &str)=NULL); /* overload constructor pProcessString(sender, irCode) */

  void begin(long BaudRate=115200, void(*pProcessString)(String &str)=NULL );
...
extern TPCSerialManager PCSerialManager;
