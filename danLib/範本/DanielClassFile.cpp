...
#include "DanielClassFile.h"



TDanielClasser::TDanielClasser()
{
	CreateMembers();
	InitialMembers();
}
...
TDanielClasser::TDanielClasser(byte val,  void(*pCallbackFunc)(TDanielClasser *, byte &paramVal))
{
	CreateMembers();
	InitialMembers();
...
void TDanielClasser::Initial(byte val, void(*pCallbackFunc)(TDanielClasser *, byte &paramVal))
{
	FOnCallBack_myCheck = pCallbackFunc;
}

void TDanielClasser::CreateMembers()
{

}

void TDanielClasser::InitialMembers()
{

}

void TDanielClasser::ReleaseMembers()
{
...
/*
void TDanielClasser::DomyCheck()
{
	if (NULL != this->FOnCallBack_myCheck)
	{
		byte paramVal = 0;
		FOnCallBack_myCheck(this, paramVal);
	}
}

void TDanielClasser::HelloWorld(TDanEnum de)
{
	switch (de)
	{
	case de01:
...
TDanielClasser DanielClasser(0,NULL);
